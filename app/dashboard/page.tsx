...
export default function DashboardPage() {
    ...
    return (
        <div className="space-y-8">
            {/* Welcome Section */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 shadow-lg dark:from-indigo-900 dark:via-purple-900 dark:to-pink-900">
                <div className="relative z-10">
                    <h2 className="text-3xl font-bold text-white">Welcome back, Admin!</h2>
                    <p className="mt-2 text-indigo-100">Here's what's happening with your team today.</p>
                </div>
